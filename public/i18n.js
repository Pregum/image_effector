...
const EN = {
  ...
  "表示する": "Show",
  "削除": "Delete",
  "プレビュー上をドラッグしても動かせます。合成した上からエフェクトが全体にかかります。":
    "Drag on the preview to move a layer. Effects are applied to the whole composite.",
  "極太": "Heavy",
  "明朝": "Mincho",
  "丸ゴ": "Round",
  "ポップ": "Pop",
  ...
  // --- 時事クロスワード ---
  "NOIZ LAB — 時事クロスワード": "NOIZ LAB — News Crossword",
